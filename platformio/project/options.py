...
ProjectOptions = OrderedDict(
    [
        ...
        for option in [
            ...
            ConfigPlatformioOption(
                name="lib_dir", sysenvvar="PLATFORMIO_LIB_DIR"
            ),
            ConfigPlatformioOption(
                name="include_dir", sysenvvar="PLATFORMIO_INCLUDE_DIR"
            ),
            ConfigPlatformioOption(
                name="src_dir", sysenvvar="PLATFORMIO_SRC_DIR"
            ),
            ConfigPlatformioOption(
            ...
            # Build
            ConfigEnvOption(
                name="build_type", type=click.Choice(["release", "debug"])
            ),
            ConfigEnvOption(
                name="build_flags",
                multiple=True,
            ...
            ConfigEnvOption(
                name="upload_protocol", buildenvvar="UPLOAD_PROTOCOL"
            ),
            ConfigEnvOption(
